...
const String _sdkKey =
    "hPM7L7Smsd_c9d8UO8dSybWVLUJFrFkPmGuEkuDeOxeFExon0i1B7TSWZFDDVsBiAC60RbdCBd8iix_m6EnieT";

final String _interstitialAdUnitId =
    Platform.isAndroid ? "75feabe7995fdb90" : "'";
final String _rewardedAdUnitId = Platform.isAndroid ? "c8214e08476eeac3" : "'";
final String _bannerAdUnitId = Platform.isAndroid ? "bfabef578922553c" : "";
final String _mrecAdUnitId = Platform.isAndroid ? "7873b0dc82b26f89" : "";
                            ...
                            if (_isProgrammaticMRecShowing) {
                              ...
                              if (!_isProgrammaticMRecCreated) {
                                AppLovinMAX.createMRec(
                                    _mrecAdUnitId, AdViewPosition.bottomCenter);
